...
use Domain\Portfolio\Controller\PortfolioTransactionsController;
use Domain\Portfolio\Controller\PortfolioWholeShareBuySegmentsController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/portfolios/{portfolio}/transactions/whole-share-buy-segments', PortfolioWholeShareBuySegmentsController::class);
    Route::get('/portfolios/{portfolio}/transactions', PortfolioTransactionsController::class);
